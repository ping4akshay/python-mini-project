...
print("An inspector from the Department of Health and ", random.choice(list_noun) , " Services paid a surprise visit to our " , random.choice(adjective) , " school cafeteria.")
print("The lunch special, prepared by our " , random.choice(adjective) , "dietician, was spaghetti and " , random.choice(list_noun) , " balls with a choice of either a " , random.choice(list_noun) , " salad or French " , random.choice(plural) , ".")
